    ...
    return (
        <section className="py-[6rem]">
            <div className="container mx-auto">
                ...
                <div className="pt-[3rem] ps-[2rem] border-b border-neutral-500" >
                    <div className="">
                        <h3 className="text-[4rem] font-medium">
                            FRONTEND DEVELOPER
                        </h3>
                        <p className="text-[2rem] font-thin mb-[0.5rem]">I help companies from all over the world with tailor-made solutions.
                ...
                >
                    ...
                    {aboutmes.map((aboutme, x) => (
                        <div className="border rounded-sm h-full flex flex-col mt-[3.5rem] p-[24px]
            hover:shadow-lg shadow-md text-neutral-600 hover:text-primary"
                            ...
                            <p className="text-neutral-600 font-medium mx-auto text-center">{aboutme.desc}</p>
                        </div>
                    ))}
